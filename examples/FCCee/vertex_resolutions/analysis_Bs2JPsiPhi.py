    ...
    def run(self):
        ...
        df2 = (self.df
	       ...
	       .Define("Angle_JpsiPhi",  "AngleBetweenTwoMCParticles( JPsi, Phi)" )
               ...
               .Define("Bs2MuMuKK_indices",  "getMC_indices_ExclusiveDecay( 531, {-13,13,321,-321}, true, true) ( Particle, Particle1)" )
               ...
               .Define("Bs_theta",   "getMC_theta( Bs )")
               .Define("Bs_phi",   "getMC_phi( Bs )")
               .Define("Bs_e",   "getMC_e( Bs )")
